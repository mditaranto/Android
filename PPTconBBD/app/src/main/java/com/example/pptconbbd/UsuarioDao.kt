...
interface UsuarioDao {
    ...
    @Query("SELECT * FROM Usuario_Entity ORDER BY victorias DESC")
    ...
    suspend fun getUsuarioByUsername(id: Long): UsuarioEntity        // Función que busca tareas por id (debe ser String)
